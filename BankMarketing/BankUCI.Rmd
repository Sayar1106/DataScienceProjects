...
rf_model<-train(y~.,data = train_data, method = "rf", trControl = control_param, metric = "F1score", family = "binomial")
...
rf_train_preds<-predict(object = rf_model, type = "raw")
...
pred <- prediction(predictions = rf_test_preds[,2], labels = test_data$y)
rf_test_preds
